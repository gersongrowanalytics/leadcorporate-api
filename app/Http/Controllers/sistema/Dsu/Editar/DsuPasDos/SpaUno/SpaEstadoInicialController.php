...
namespace App\Http\Controllers\sistema\Dsu\Editar\DsuPasDos\SpaUno;
...
class SpaEstadoInicialController extends Controller
{
    public function EditarSpaEstadoInicial(Request $request)
    {
        $respuesta      = true;
